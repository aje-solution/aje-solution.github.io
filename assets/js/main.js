  ...
  window.onscroll = function () {
    ...
    if (logo.length) {
      ...
      if (ud_header.classList.contains("sticky")) {
        ...
        document.getElementById("text-logo").className = "text-dark dark:text-white tracking-wider text-xl md:text-lg lg:text-lg w-full font-bold"
      } else {
        document.querySelector(".header-logo").src = "assets/images/logo tanpa nama.png"
      ...
      if (logo.length) {
        ...
        if (ud_header.classList.contains("sticky")) {
          document.querySelector(".header-logo").src =
            "assets/images/logo tanpa nama.png"
        }
      }
    }
